...
export function Sidebar({ config, onChange }: SidebarProps) {
  ...
  return (
    <aside className="w-[304px] border-r border-line bg-surface-secondary/40 overflow-y-auto flex-shrink-0">
      <div className="p-5 space-y-7">
        ...
        <Section title="Typography">
          <Field label="Font Family">
            <select
              ...
              className="w-full bg-surface-tertiary border border-line rounded-lg px-3 py-2 text-sm text-content focus:outline-none focus:ring-2 focus:ring-content-faint focus:border-transparent"
            >
              {FONT_OPTIONS.map((f) => (
        ...
        <Section title="Layout">
          ...
          <Field label="Border Radius">
            <div className="flex bg-surface-tertiary rounded-lg p-1 gap-0.5">
...
function ColorInput({
  ...
  return (
    <div className="flex items-center gap-2.5">
      <div className="relative w-9 h-9 rounded-lg overflow-hidden border border-line flex-shrink-0 shadow-sm">
        <input
          type="color"
          value={value}
          onChange={(e) => {
      ...
      <input
        ...
        maxLength={7}
        className="flex-1 bg-surface-tertiary border border-line rounded-lg px-3 py-2 text-sm font-mono text-content focus:outline-none focus:ring-2 focus:ring-content-faint focus:border-transparent tracking-wide"
      />
    </div>
  );
}
